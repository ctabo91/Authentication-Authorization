...
def register_user():
    ...
    and adds user to the database when form is filled out."""
...
def login_user():
    ...
    and logs in if the credentials are correct."""
...
def show_secret(username):
    """Show secret page, if user logged in or registered successfully"""
